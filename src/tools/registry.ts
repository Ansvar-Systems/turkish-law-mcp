/**
 * Tool registry for Turkish Law MCP Server.
...
import { getTurkishImplementations, type GetTurkishImplementationsInput } from './get-turkish-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including the Federal Register of Legislation (Turkish Government, Office of Parliamentary Counsel). ' +
    ...
    'Call this FIRST when you need to understand what Turkish legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Turkish statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section) from an Turkish statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate an Turkish legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Turkish statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Turkey?" ' +
  ...
  },
  {
    ...
    description:
      'Format an Turkish legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether an Turkish statute or provision is currently in force, amended, repealed, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU legal basis that an Turkish statute references or aligns with. ' +
      'Turkey is not an EU member but Turkish laws may reference EU directives/regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Turkish statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_turkish_implementations',
    description:
      'Find all Turkish statutes that reference or align with a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Turkish statutes. ' +
      'Note: Turkey does not transpose EU law but may reference or align with EU frameworks voluntarily.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that are referenced by Turkish legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_turkish_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents referenced by Turkish legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU legal basis for a SPECIFIC provision within an Turkish statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU alignment status for an Turkish statute or provision. ' +
      ...
      'Note: Turkey is not bound by EU law; this checks voluntary alignment and cross-references.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Turkish statute identifier.' },
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_turkish_implementations':
          result = await getTurkishImplementations(db, args as unknown as GetTurkishImplementationsInput);
          break;
